...
public static class IdentityApiEndpointRouteBuilderExtensions
{
        ...
        where TUser : class, new()
    {
        ...
        var authGroup = routeGroup.MapGroup("/auth");
        ...
        authGroup.MapGet("/confirmEmail", async Task<Results<ContentHttpResult, UnauthorizedHttpResult>>
        ...
        authGroup.MapPost("/forgotPassword", async Task<Results<Ok, ValidationProblem>>
        ...
        authGroup.MapPost("/resetPassword", async Task<Results<Ok, ValidationProblem>>
